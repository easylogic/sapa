...
export declare class UIElement extends EventMachine {
     ...
     */
    nextTick(callback: Function, delay?: number): void;
    /**
     *
     ...
     */
    on(message: string, callback: Function, debounceDelay?: number, throttleDelay?: number, enableAllTrigger?: boolean, enableSelfTrigger?: boolean, frame?: boolean): void;
    /**
